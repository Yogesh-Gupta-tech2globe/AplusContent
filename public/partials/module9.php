    ...
    <div class="row align-items-center">
        <div class="col-lg-6 col-md-12 col-12">
            <div class="position-relative">
                <img src="<?php echo esc_url($item['module9Image1']); ?>" class="img-fluid w-100" style="object-fit: cover;" alt="" />
        ...
        <div class="col-lg-6 col-md-12 col-12">
            <div class="position-relative">
                <img src="<?php echo esc_url($item['module9Image2']); ?>" class="img-fluid w-100" style="object-fit: cover;" alt="" />
